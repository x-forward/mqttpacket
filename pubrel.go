...
func NewPubRel(fh *FixedHeader, buffer *bytes.Buffer, version byte) *PubRel {
	return &PubRel{
		Buffer:      buffer,
		Version:     version,
		FixedHeader: fh,
...
func (p *PubRel) Decode() (*PubRel, error) {
...
func (p *PubRel) decodeVariant() (err error) {
...
func (p *PubRel) encodeVariant() (result []byte, err error) {
	if p.PacketID > 0 {
